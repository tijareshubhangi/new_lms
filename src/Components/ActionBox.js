...
const ActionBox = () => {
  return (
    <section className="py-0 pt-lg-5 mt-5">
        ...
        <div className="row">
          <div className="col-12 position-relative z-index-1">
            ...
            <div className="position-absolute bottom-0 start-50 mb-n4">
              <img src="assets/images/client/graduated.svg" className="rotate-74" alt="" />
            </div>
            ...
            <div className="bg-grad-pink p-4 p-sm-5 rounded position-relative z-index-n1 overflow-hidden">
              ...
              <div className="row g-3 align-items-center justify-content-lg-end position-relative py-4">
                ...
                <div className="col-md-6">
                  <h2 className="text-white">Unlock Your Learning Potential!</h2>
                  <p className="text-white mb-0">Explore Courses and Enhance Your Skills Today!</p>
                </div>
                {/* Button */}
                <div className="col-md-6 col-lg-3 text-md-end">
                  <Link to="/coursemore" className="btn btn-white mb-0">Get Started Now!</Link>
                </div>
              </div> {/* Row END */}
            </div>
          </div>
