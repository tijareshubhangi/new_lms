...
<section className="bg-lights position-relative overflow-hidden">
  ...
  <div className="container position-relative">
    ...
    {/* Outer tabs START */}
    <ul className="nav nav-pills nav-pill-soft mb-3" id="course-pills-tab" role="tablist">
      {/* Tab item */}
      <li className="nav-item me-2 me-sm-5" role="presentation">
        <button className="nav-link active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-tab1" type="button" role="tab" aria-controls="course-pills-tab1" aria-selected="true">Art &amp; Design</button>
      </li>
      {/* Tab item */}
      <li className="nav-item me-2 me-sm-5" role="presentation">
        <button className="nav-link" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-tab2" type="button" role="tab" aria-controls="course-pills-tab2" aria-selected="false">Development</button>
      </li>
      {/* Tab item */}
      <li className="nav-item me-2 me-sm-5" role="presentation">
        <button className="nav-link" id="course-pills-tab-3" data-bs-toggle="pill" data-bs-target="#course-pills-tab3" type="button" role="tab" aria-controls="course-pills-tab3" aria-selected="false">Data Science</button>
      </li>
      {/* Tab item */}
      <li className="nav-item me-2 me-sm-5" role="presentation">
        <button className="nav-link" id="course-pills-tab-4" data-bs-toggle="pill" data-bs-target="#course-pills-tab4" type="button" role="tab" aria-controls="course-pills-tab4" aria-selected="false">Marketing</button>
      </li>
      {/* Tab item */}
      <li className="nav-item me-2 me-sm-5" role="presentation">
        <button className="nav-link" id="course-pills-tab-5" data-bs-toggle="pill" data-bs-target="#course-pills-tab5" type="button" role="tab" aria-controls="course-pills-tab5" aria-selected="false">Finance</button>
      </li>
    </ul> 
    {/* Outer tabs END */}
    ...
    <div className="tab-content mb-0" id="course-pills-tabContent">
      {/* Outer content START */}
      <div className="tab-pane fade show active" id="course-pills-tab1" role="tabpanel" aria-labelledby="course-pills-tab-1">
        <div className="row">
          <div className="col-12">
            <div className="row justify-content-between">
              ...
              <div className="col-lg-6">
                ...
                {/* Inner tabs START */}
                <ul className="nav nav-pills nav-pill-dark-soft mb-0" id="course-pills-tab-inner" role="tablist">
                  {/* Tab item */}
                  <li className="nav-item me-2 me-sm-3" role="presentation">
                    <button className="nav-link active" id="course-pills-tab-01" data-bs-toggle="pill" data-bs-target="#course-pills-tab01" type="button" role="tab" aria-controls="course-pills-tab01" aria-selected="true">Art &amp; Design</button>
                  </li>
                  {/* Tab item */}
                  <li className="nav-item me-2 me-sm-3" role="presentation">
                    <button className="nav-link" id="course-pills-tab-02" data-bs-toggle="pill" data-bs-target="#course-pills-tab02" type="button" role="tab" aria-controls="course-pills-tab02" aria-selected="false">Graphic Design</button>
                  </li>
                  {/* Tab item */}
                  <li className="nav-item me-2 me-sm-3" role="presentation">
                    <button className="nav-link" id="course-pills-tab-03" data-bs-toggle="pill" data-bs-target="#course-pills-tab03" type="button" role="tab" aria-controls="course-pills-tab03" aria-selected="false">Web Design</button>
                  </li>
                </ul>
                {/* Inner tabs END */}
                {/* Rating */}
              ...
              <div className="col-lg-6 position-relative">
                ...
                <div className="tab-content mb-0 pb-0" id="course-pills-tabContent1">
                  {/* Inner content item START */}
                  <div className="tab-pane fade show active" id="course-pills-tab01" role="tabpanel" aria-labelledby="course-pills-tab-01">
                    {/* Card START */}
                    <div className="card p-2 pb-0 shadow">
                      <div className="overflow-hidden h-xl-200px">
                        <img src="assets/images/about/13.jpg" className="card-img-top" alt="course image" />
                        ...
                        <div className="row g-3">
                          ...
                          <div className="col-sm-4 col-lg-6 col-xl-4">
                            <div className="d-flex align-items-center">
                              <a href="#" className="btn btn-orange rounded-2 me-3 mb-0"><i className="bi bi-cart3 fs-5" /></a>
                              <div>
                                {/* Badge */}
                                <span className="badge text-bg-info mb-1">6 months</span>
                          ...
                          <div className="col-sm-4 col-lg-6 col-xl-4">
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                {/* Badge */}
                                <span className="badge text-bg-info mb-1">12 months</span>
                          ...
                          <div className="col-sm-4 col-lg-6 col-xl-4">
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                {/* Badge */}
                                <span className="badge text-bg-info mb-1">18 months</span>
                  ...
                  {/* Inner content item START */}
                  <div className="tab-pane fade" id="course-pills-tab02" role="tabpanel" aria-labelledby="course-pills-tab-02">
                    {/* Card START */}
                    <div className="card p-2 pb-0 shadow">
                      <div className="overflow-hidden h-xl-200px">
                        <img src="assets/images/about/11.jpg" className="card-img-top" alt="course image" />
                        <div className="card-img-overlay d-flex p-3">
                          {/* Video button and link */}
                          <div className="m-auto">
                            <a href="https://www.youtube.com/embed/tXHviS-4ygo" className="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox data-gallery="course-video">
                        ...
                        <div className="row g-3">
                          ...
                          <div className="col-sm-4 col-lg-6 col-xl-4">
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                {/* Badge */}
                                <span className="badge text-bg-info mb-1">6 month</span>
                          ...
                          <div className="col-sm-4 col-lg-6 col-xl-4">
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                {/* Badge */}
                                <span className="badge text-bg-info mb-1">12 month</span>
                          ...
                          <div className="col-sm-4 col-lg-6 col-xl-4">
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                {/* Badge */}
                                <span className="badge text-bg-info mb-1">18 month</span>
                  ...
                  {/* Inner content item END */}
                  {/* Inner content item START */}
                  <div className="tab-pane fade" id="course-pills-tab03" role="tabpanel" aria-labelledby="course-pills-tab-03">
                    {/* Card START */}
                    <div className="card p-2 shadow">
                      <div className="overflow-hidden h-xl-200px">
                        <img src="assets/images/about/14.jpg" className="card-img-top" alt="course image" />
                        <div className="card-img-overlay d-flex p-3">
                          {/* Video button and link */}
                          <div className="m-auto">
                            <a href="https://www.youtube.com/embed/tXHviS-4ygo" className="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox data-gallery="course-video">
      ...
      {/* Outer content END */}
      {/* Outer content START */}
      <div className="tab-pane fade" id="course-pills-tab2" role="tabpanel" aria-labelledby="course-pills-tab-2">
        <div className="row">
          {/* Left content START */}
          <div className="col-lg-6">
            {/* Title */}
            ...
            <ul className="list-group list-group-borderless mb-3">
              <li className="list-group-item h6 fw-light d-flex mb-0"><i className="bi bi-patch-check-fill text-success me-2" />Create responsive, accessible, and beautiful layouts</li>
              <li className="list-group-item h6 fw-light d-flex mb-0"><i className="bi bi-patch-check-fill text-success me-2" />Course Videos &amp; Readings</li>
              <li className="list-group-item h6 fw-light d-flex mb-0"><i className="bi bi-patch-check-fill text-success me-2" />Manipulate the DOM with vanilla JS</li>
              <li className="list-group-item h6 fw-light d-flex mb-0"><i className="bi bi-patch-check-fill text-success me-2" />Master the command line interface</li>
              <li className="list-group-item h6 fw-light d-flex mb-0"><i className="bi bi-patch-check-fill text-success me-2" />Create your own Node modules</li>
            </ul>
          </div>
          {/* Left content END */}
          {/* Right content START */}
      ...
      {/* Outer content END */}
      {/* Outer content START */}
      <div className="tab-pane fade" id="course-pills-tab3" role="tabpanel" aria-labelledby="course-pills-tab-3">
        <div className="row g-4">
          ...
          <div className="col-lg-6">
            ...
            {/* Buttons */}
            <div className="mt-3">
              <a href="#" className="btn btn-success">Free trial</a>
              <a href="#" className="btn btn-danger">Buy course</a>
            </div>
          </div>
          {/* Left content END */}
          {/* Right content START */}
          <div className="col-lg-6">
            ...
            <div className="card p-2 shadow">
              <div className="overflow-hidden rounded-3 h-xl-200px">
                <img src="assets/images/about/15.jpg" className="card-img rounded-3" alt="course image" />
                <div className="card-img-overlay d-flex p-3">
                  {/* Video button and link */}
                  <div className="m-auto">
                    <a href="https://www.youtube.com/embed/tXHviS-4ygo" className="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox data-gallery="course-video">
      ...
      {/* Outer content END */}
      {/* Outer content START */}
      <div className="tab-pane fade" id="course-pills-tab4" role="tabpanel" aria-labelledby="course-pills-tab-4">
        <div className="row g-4">
          {/* Left content START */}
          <div className="col-lg-6">
            {/* Title */}
          ...
          <div className="col-lg-6">
            ...
            <div className="card p-2 shadow">
              <div className="overflow-hidden rounded-3 h-xl-200px">
                <img src="assets/images/about/12.jpg" className="card-img rounded-3" alt="course image" />
                <div className="card-img-overlay d-flex p-3">
                  {/* Video button and link */}
                  <div className="m-auto">
                    <a href="https://www.youtube.com/embed/tXHviS-4ygo" className="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox data-gallery="course-video">
      ...
      {/* Outer content END */}
      {/* Outer content START */}
      <div className="tab-pane fade" id="course-pills-tab5" role="tabpanel" aria-labelledby="course-pills-tab-5">
        <div className="row g-4">
          {/* Left content START */}
          <div className="col-lg-6">
            {/* Title */}
          ...
          <div className="col-lg-6">
            ...
            <div className="card p-2 shadow">
              <div className="overflow-hidden rounded-3 h-xl-200px">
                <img src="assets/images/about/11.jpg" className="card-img rounded-3" alt="course image" />
                <div className="card-img-overlay d-flex p-3">
                  {/* Video button and link */}
                  <div className="m-auto">
                    <a href="https://www.youtube.com/embed/tXHviS-4ygo" className="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox data-gallery="course-video">
