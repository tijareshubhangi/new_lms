                ...
                <table className="table table-dark-gray align-middle p-4 mb-0 table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      {/* Table data */}
                      <td>
                        <a href="#" className="btn btn-info-soft btn-round me-1 mb-1 mb-md-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Message">
                          <i className="bi bi-envelope" />
                        </a>
                        <a href="#" className="btn btn-success-soft btn-round me-1 mb-1 mb-md-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                          <i className="bi bi-pencil-square" />
                        </a>
                        <button className="btn btn-danger-soft btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
...
export default AdminInstructirList